"""Configuración del servicio API de búsqueda (PR-054 · FR-006 · SEC-001/006 · ADR-0012).
...
Sección base del bootstrap (PR-054): bind local (SEC-001), DSN de servidor
(SEC-004), proveedor de embeddings (paridad CLI), `work_root` para los
temporales de media de consulta (SEC-005; uso en PR-055) y allowlist CORS.
Las secciones search (top_k/min_score) y TTL llegan en PR-055/056.
"""
